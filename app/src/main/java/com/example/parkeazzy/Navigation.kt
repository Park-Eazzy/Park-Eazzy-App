...
import com.example.parkeazzy.login.LoginScreen
import com.example.parkeazzy.signup.SignUpScreen
...
@Composable
fun ParkNavigation(navHostController: NavHostController) {
    NavHost(
